...
- ```mkdir CS506```(to create a directory for this course)<br/>
- ```cd CS506```(to change directory to CS506 you just created) </br>
...
KimNguyen/Desktop/CS506/HOP01-KimNguyenMai/Module 1 <br/>
